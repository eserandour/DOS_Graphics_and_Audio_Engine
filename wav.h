...
/* =========================================================
   ...
   RAM (far heap), convertit les échantillons au format
   ...
   LIMITES
   -------
   - Un seul bloc _fmalloc par son : la durée est donc
     limitée à 65535 échantillons sources (voir wav.c).
...
/* Mixe les voies actives par-dessus 'n' octets déjà présents
   dans buf (far) — buf doit déjà contenir la musique (voir
