...
/* =========================================================
   ...
   d'origine et libère toute la mémoire far allouée. Elle
...
#define AUD_ERR_MEM     2   /* mémoire far insuffisante            */
...
/* Charge et joue en boucle un module de musique .s3m. Coupe
   ...
   mémoire far insuffisante) — utile pour afficher un
   diagnostic à l'écran plutôt qu'un échec silencieux. */
int playMusic(const char *filename);

/* Arrête la musique en cours et libère intégralement la mémoire far
...
/* Fait descendre la musique en cours de son niveau actuel jusqu'au
   ...
   de jouer (et donc de consommer la mémoire far du module), juste
